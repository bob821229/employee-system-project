<template>
        ...
        <el-row :gutter="10">
            ...
            <el-col :sm="24" :md="12" :lg="6">
                <el-form-item label="部門" prop="department">
                    ...
                    >
                        <el-option
                            v-for="d in options.departmentList"
                            :key="d.value"
                            :label="d.text"
                            :value="d.value"
                        />
            ...
            <el-col :sm="24" :md="12" :lg="6">
                <el-form-item label="到職日" prop="arrivalDate">
                    <el-date-picker
                        v-model="currentData.arrivalDate"
                        type="date"
                        style="width: 100%"
                        placeholder="請選擇到職日"
                        format="YYYY/MM/DD"
            ...
            <el-col :sm="24" :md="12" :lg="6">
                <el-form-item label="職稱" prop="positionTitle">
                    <el-select
                        v-model="currentData.positionTitle"
                        placeholder="選擇職稱"
                        :disabled="!isHRUser"
                    >
                        <el-option
                            v-for="d in options.positionTitleList"
                            :key="d.value"
                            :label="d.text"
                            :value="d.text"
                        />
                ...
                <el-form-item label="照片" prop="profileImageUrl">
                    ...
                    >
                        <template #trigger>
                            <!-- {{currentData.profileImageUrl}} -->
                             <!-- {{ displayUrl }} -->
                            <!-- 上傳進度條 -->
                            <el-progress v-if="uploading" type="circle" :percentage="uploadProgress" />
                            <!-- 照片及添加按鈕 -->
                    ...
                    <div class="actions">
                        <!-- <el-button
                            ...
                            >上傳</el-button
                        > -->
                        <el-button v-if="previewFile" :disabled="uploading" @click="onRemove"
                            >清除</el-button
                        >
                    </div>
            ...
            <!-- 照片 -->
            <el-col :sm="24" :md="6" :lg="3" v-if="false">
                <el-form-item label="照片" prop="profileImageUrl">
                    <el-upload
            ...
            <el-col :span="24">
                <el-row style="width: 100%; align-items: end" :gutter="10">
                    ...
                    <el-col :sm="24" :md="24" :lg="3">
                        <el-form-item
                            label="戶籍地址"
                            prop="residencePostalCode"
                        >
                            <el-input
                                v-model="currentData.residencePostalCode"
                                disabled
                                placeholder="請輸入郵遞區號"
                            >
                            </el-input>
                    ...
                    <el-col :sm="24" :md="24" :lg="4">
                        <el-form-item label=" " prop="residenceCity">
                            <el-select
                                v-model="currentData.residenceCity"
                                placeholder="請選擇縣市"
                    ...
                    <el-col :sm="24" :md="24" :lg="4">
                        <el-form-item label=" " prop="residenceDistrict">
                            <el-select
                                v-model="currentData.residenceDistrict"
                                placeholder="請選擇行政區"
                                @change="changeResidenceDistrict"
                            >
                                <el-option
                                    v-for="c in residenceDistrictList"
                                    :key="c.district"
                                    :label="c.district"
                                    :value="c.district"
                                />
                    ...
                    <el-col :sm="24" :md="24" :lg="10">
                        <el-form-item label=" " prop="residenceAddress">
                            <el-input
                                v-model="currentData.residenceAddress"
                                placeholder="請輸入戶籍地址(不含郵地區號、縣市、行政區)"
                            >
                            </el-input>
                        </el-form-item>
                    </el-col>
            ...
            <el-col :sm="24" :md="24" :lg="3">
                <el-form-item label="通訊地址" prop="mailingPostalCode">
                    <el-input
                        v-model="currentData.mailingPostalCode"
                        disabled
                        placeholder="請輸入郵遞區號"
                    >
                    </el-input>
            ...
            <el-col :sm="24" :md="24" :lg="4">
                <el-form-item label=" " prop="mailingCity">
                    <el-select
                        v-model="currentData.mailingCity"
                        placeholder="請選擇縣市"
            ...
            <el-col :sm="24" :md="24" :lg="4">
                <el-form-item label=" " prop="mailingDistrict">
                    <el-select
                        v-model="currentData.mailingDistrict"
                        placeholder="請選擇行政區"
                        @change="changeMailingDistrict"
                    >
                        <el-option
                            v-for="c in mailingDistrictList"
                            :key="c.district"
                            :label="c.district"
                            :value="c.district"
                        />
            ...
            <el-col :sm="24" :md="24" :lg="13">
                <el-form-item label=" " prop="mailingAddress">
                    <el-input
                        v-model="currentData.mailingAddress"
                        placeholder="請輸入通訊地址(不含郵地區號、縣市、行政區)"
                    >
                    </el-input>
                </el-form-item>
            </el-col>
            ...
            <el-col :sm="24" :md="12" :lg="6">
                <el-form-item label="特殊身分" prop="specialStatus">
                    ...
                    >
                        <el-option
                            v-for="d in options.specialStatuList"
                            :key="d.value"
                            :label="d.text"
                            :value="d.text"
                        />
            ...
            <el-col :sm="24" :md="12" :lg="6">
                <el-form-item label="駕照" prop="drvingLicense">
                    <el-select
                        v-model="currentData.drvingLicense"
                        multiple
                        placeholder="請選擇駕照"
                        @change="handleLicenseChange"
                    >
                        <el-option
                            v-for="d in options.drvingLicenseList"
                            :key="d.value"
                            :label="d.text"
                            :value="d.text"
                        />
            ...
            <el-col :sm="24" :md="12" :lg="6">
                <el-form-item label="婚姻狀況" prop="maritalStatus">
                    ...
                    >
                        <el-option
                            v-for="d in options.maritalStatusList"
                            :key="d.value"
                            :label="d.text"
                            :value="d.text"
                        />
            ...
            <el-col :sm="24" :md="12" :lg="6" v-if="isHRUser">
                <el-form-item label="離職日期" prop=" lastWorkingDate">
                    <el-date-picker
                        v-model="currentData.lastWorkingDate"
                        type="date"
                        style="width: 100%"
                        placeholder="請選擇離職日期"
                        format="YYYY/MM/DD"
            ...
            <el-col :span="24">
                <el-row
                    ...
                    :gutter="10"
                    v-for="(school, index) in currentData.educationExperiences"
                    :key="index"
                ...
                >
                    <el-col :span="2">
                        ...
                        >
                            <el-select
                                v-model="school.academicDegree"
                                placeholder="請選擇學位"
                            >
                                <el-option disabled label="請選擇" value="" />
                                <el-option
                                    v-for="d in options.academicDegreeList"
                                    :key="d.value"
                                    :label="d.text"
                                    :value="d.value"
                                />
                    ...
                    <el-col :span="5">
                        <el-form-item
                            label="學校名稱"
                            :prop="'educationExperiences.' + index + '.name'"
                            :rules="{
                                required: true,
                                message: '請輸入學校名稱',
                                trigger: 'blur',
                    ...
                    <el-col :span="6">
                        <el-form-item
                            label="科系"
                            :prop="
                                'educationExperiences.' + index + '.department'
                            "
                            :rules="{
                                required: true,
                                message: '請輸入科系',
                    ...
                    <el-col :span="2">
                        ...
                        >
                            <el-select
                                v-model="school.degreeStatus"
                                placeholder="請選擇畢業/肄業"
                            >
                                <el-option disabled label="請選擇" value="" />
                                <el-option
                                    v-for="d in options.graduateStatusList"
                                    :key="d.value"
                                    :label="d.text"
                                    :value="d.value"
                                />
                    ...
                    <el-col :span="4">
                        <el-form-item
                            label="開始年月"
                            :prop="
                                'educationExperiences.' + index + '.startFrom'
                            "
                            :rules="{
                                type: 'date',
                                required: false,
                    ...
                    <el-col :span="4">
                        <el-form-item
                            label="結束年月"
                            :prop="'educationExperiences.' + index + '.endAt'"
                            :rules="{
                                type: 'date',
                                required: false,
                                message: '請選擇服務訖年月',
                    ...
                    <el-col :span="1">
                        ...
                        >
                            ...
                            <el-button
                                ...
                                type="danger"
                                @click="
                                    removeEducationExperience(index, school)
                                "
                            >
                                <!-- 刪除學歷 -->
                                <el-icon>
            ...
            <el-col :span="24">
                <el-row
                    style="width: 100%; align-items: end"
                    :gutter="10"
                    v-for="(experience, index) in currentData.workExperiences"
                    :key="index"
                    class="work-experience-item"
                >
                    <el-col :span="8">
                    ...
                    <el-col :span="7">
                        <el-form-item
                            label="職務名稱"
                            :prop="'workExperiences.' + index + '.position'"
                            :rules="{
                                required: true,
                                message: '請輸入職務名稱',
                                trigger: 'blur',
                    ...
                    <el-col :span="4">
                        <el-form-item
                            label="開始年月"
                            :prop="'workExperiences.' + index + '.startFrom'"
                            :rules="{
                                type: 'date',
                                required: false,
                                message: '請選擇服務起年月',
                    ...
                    <el-col :span="4">
                        <el-form-item
                            label="結束年月"
                            :prop="'workExperiences.' + index + '.endAt'"
                            :rules="{
                                type: 'date',
                                required: false,
                                message: '請選擇服務訖年月',
                    ...
                    <el-col :span="4" v-if="false">
                        <el-form-item
                            label="薪資"
                            :prop="'workExperiences.' + index + '.salary'"
                            :rules="[
                                {
                                    required: true,
                                    message: '請輸入薪資',
                        ...
                        >
                            <el-input
                                v-model.number="experience.salary"
                                placeholder="請輸入薪資"
                            />
                        </el-form-item>
                    </el-col>
                    <el-col :span="5" v-if="false">
                        <el-form-item
                            label="離職原因"
                            :prop="
                                'workExperiences.' + index + '.leavingReason'
                            "
                            :rules="{
                                required: true,
                                message: '請輸入離職原因',
                        ...
                        >
                            <el-input
                                v-model="experience.leavingReason"
                                placeholder="請輸入離職原因"
                            />
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="1">
                        ...
                        >
                            ...
                            <el-button
                                plain
                                type="danger"
                                @click="removeWorkExperience(index, experience)"
                            >
                                <!-- 刪除經歷 -->
                                <el-icon>
                                    <Delete />
            ...
            <el-col :span="24">
                <el-row justify="center">
                    <el-button plain type="success" @click="addWorkExperience()"
                        >新增</el-button
                    >
                </el-row>
            </el-col>
            ...
            <el-col :sm="24" :md="8" :lg="8">
                <el-form-item label="語言能力">
                    ...
                    >
                        <el-option
                            v-for="l in options.languageList"
                            :key="l.value"
                            :label="l.text"
                            :value="l.text"
                        />
            ...
            <el-col :sm="24" :md="8" :lg="8">
                <el-form-item label="特殊專長">
                    <el-select
                        v-model="currentData.computerExpertise"
                        placeholder="選擇特殊專長"
                        multiple
                        filterable
                        allow-create
                    ...
                    >
                        <el-option
                            v-for="d in options.expertiseList"
                            :key="d.value"
                            :label="d.text"
                            :value="d.text"
                        />
            ...
            <el-col :sm="24" :md="8" :lg="8">
                <el-form-item label="專業證照">
                    ...
                    <el-select
                        v-model="currentData.professionalLicense"
                        placeholder="請輸入專業證照"
                        multiple
                        filterable
                        allow-create
                    ...
                    >
                        <el-option
                            v-for="d in options.professionalLicenseList"
                            :key="d.value"
                            :label="d.text"
                            :value="d.text"
                        />
            ...
            <el-col :span="24">
                <el-row
                    ...
                    ) in currentData.emergencyContacts"
                    :key="index"
                    class="work-experience-item"
                >
                    <el-col :span="6">
                        <el-form-item
                            label="姓名"
                            :prop="'emergencyContacts.' + index + '.name'"
                            :rules="{
                                required: true,
                                message: '請輸入姓名',
                                trigger: 'blur',
                    ...
                    <el-col :span="6">
                        <el-form-item
                            label="連絡電話"
                            :prop="'emergencyContacts.' + index + '.phone'"
                            :rules="[
                                {
                                    required: true,
                                    trigger: 'blur',
                                ...
                                {
                                    pattern: /^0\d{1,3}-\d{6,8}$/,
                                    message: '請輸入正確的格式(ex:02-123456)',
                                    trigger: 'blur',
                                },
                            ]"
                        >
                    ...
                    <el-col :span="6">
                        <el-form-item
                            label="行動電話"
                            :prop="'emergencyContacts.' + index + '.mobile'"
                            :rules="[
                                {
                                    required: true,
                                    trigger: 'blur',
            ...
            <el-col :sm="12" :md="12" :lg="12" v-show="false">
                <el-form-item label="國泰世華銀行帳號" prop="bankAccount">
                    <el-input
                        v-model="currentData.bankAccount"
                        maxlength="12"
                        show-word-limit
                        placeholder="請輸入銀行帳號"
                    />
            ...
            <el-col :sm="12" :md="12" :lg="12" v-show="false">
                <el-form-item label="國泰世華銀行分行名稱" prop="bankName">
                    <el-input
                        v-model="currentData.bankName"
                        placeholder="請輸入銀行分行名稱"
                    />
                </el-form-item>
            </el-col>
            <!-- 身分證正面 -->
            <el-col :sm="12" :md="12" :lg="12" v-show="false">
                <el-form-item label="身分證正面" prop="idCardFrontImageUrl">
                    <el-upload
                        :show-file-list="false"
                        :auto-upload="false"
                        :on-change="changeIdCardFrontImage"
                        drag
                        style="width: 100%"
                    >
                        <el-watermark
                            v-if="
                                previewimageUrl1 ||
                                currentData.idCardFrontImageUrl
                            "
                            class="watermark"
            ...
            <el-col :sm="12" :md="12" :lg="12" v-show="false">
                <el-form-item label="身分證反面" prop="idCardBackImageUrl">
                    <el-upload
                        :show-file-list="false"
                        :auto-upload="false"
                        :on-change="changeIdCardBackImage"
                        drag
                        style="width: 100%"
                    >
                        <el-watermark
                            v-if="
                                previewimageUrl2 ||
                                currentData.idCardBackImageUrl
                            "
                            class="watermark"
                            :content="config.content"
                            :font="config.font"
    ...
    <div
        ...
        v-if="CONFIG.profile.isShowExportBtn"
    >
        <el-tooltip
            content="匯出人員資料表"
    ...
    <el-button @click="test">跨域測試</el-button>
</template>
...
import {
    ...
    apiGetProfile,
    apiSaveProfile,
    apiDeleteEducationExperience,
    apiDeleteWorkingExperience,
    apiDeleteEmergencyContact,
    apiGetUserProfileFile,
    apiUploadProfileImage
} from "../api/api";
import axios from "axios";
//是否顯示匯出按鈕控制config
// https://cv.triwra.org.tw/api/MetaData/getMetaDataList
const test = () => {
    let rus=axios.get('/api/api/MetaData/getMetaDataList')
    console.log("rus:",rus);
};
...
const changeArrivalDate = () => {
    ...
    let ROCyear = (
        dayjs(currentData.value.arrivalDate).format("YYYY") - 1911
    ).toString();
...
const mailingDistrictList = computed(() => {
    ...
    const selectedCounty = zipData.value.find(
        (c) => c.county === currentData.value.mailingCity
    );
...
const residenceDistrictList = computed(() => {
    ...
    const selectedCounty = zipData.value.find(
        (c) => c.county === currentData.value.residenceCity
    );
    return selectedCounty ? selectedCounty.districtList : [];
});
...
const changeResidenceCity = () => {
    currentData.value.residenceDistrict =
        residenceDistrictList.value[0].district;
    currentData.value.residencePostalCode =
        residenceDistrictList.value[0].zipcode;
};
//(通訊)改變"行政區"自動帶入"郵遞區號"
const changeMailingDistrict = () => {
    currentData.value.mailingPostalCode = mailingDistrictList.value.find(
        (d) => d.district === currentData.value.mailingDistrict
    ).zipcode;
};
//(戶籍)改變"行政區"自動帶入"郵遞區號"
const changeResidenceDistrict = () => {
    currentData.value.residencePostalCode = residenceDistrictList.value.find(
        (d) => d.district === currentData.value.residenceDistrict
    ).zipcode;
};
...
const rules = reactive({
    ...
    idNumber: [{ required: false, message: "請輸入身分證號", trigger: "blur" }],
    ...
    homePhone: [
        ...
        {
            pattern: /^0\d{1,3}-\d{6,8}$/,
            message: "請輸入正確的格式(ex:03-3216549)",
            trigger: "blur",
        },
    ],
    phone: [
    ...
    residenceCity: [{ required: true, message: "請選擇縣市", trigger: "blur" }],
    mailingDistrict: [
        { required: true, message: "請選擇行政區", trigger: "blur" },
    ],
    mailingCity: [{ required: true, message: "請選擇縣市", trigger: "blur" }],
    mailingPostalCode: [
    ...
    idCardFrontImageUrl: [
        {
            ...
            message: "請上傳身分證正面照",
            trigger: "change",
            validator: validateIdCardFrontImage,
        },
    ],
    idCardBackImageUrl: [
        {
            ...
            message: "請上傳身分證反面照",
            trigger: "change",
            validator: validateIdCardBackImage,
        },
    ],
    specialStatus: [
        {
...
// 下拉清單
const options = ref({
    departmentList: [{ text: "研究一所", value: "研究一所" }],
    sexList: [{ text: "男", value: "男" }],
    positionTitleList: [{ text: "開發人員", value: "開發人員" }],
    specialStatuList: [{ text: "原住民", value: "原住民" }],
    drvingLicenseList: [{ text: "無", value: "無" }],
    maritalStatusList: [{ text: "未婚", value: "未婚" }],
    academicDegreeList: [{ text: "博士", value: "博士" }],
    graduateStatusList: [{ text: "畢業", value: "畢業" }],
    languageList: [{ text: "國語", value: "國語" }],
    expertiseList: [{ text: "Word", value: "Word" }],
    professionalLicenseList: [
        { text: "系統分析師 (CSM)", value: "系統分析師 (CSM)" },
    ],
    paperTypeList: [{ text: "博士論文", value: "博士論文" }],
});
...
//同戶籍地址資料
const copyResidence = () => {
    currentData.value.mailingPostalCode = deepCopy(
        currentData.value.residencePostalCode
    );
    currentData.value.mailingAddress = deepCopy(
        currentData.value.residenceAddress
    );
    currentData.value.mailingCity = deepCopy(currentData.value.residenceCity);
    currentData.value.mailingDistrict = deepCopy(
        currentData.value.residenceDistrict
    );
};
...
const addEducationExperience = () => {
    ...
    let hasMaxLimit =
        CONFIG.profile.dataConstraints.educationExperiences.hasMaxLimit;
...
const removeEducationExperience = (index, obj) => {
    let hasMinLimit =
        CONFIG.profile.dataConstraints.educationExperiences.hasMinLimit;
    ...
    if (hasMinLimit && arrLength <= min) {
        ...
        let rid = obj.rid;
        ElMessageBox.confirm("確定要移除該筆教育經歷嗎?", "警告", {
            ...
            .then(async () => {
                if (obj.rid) {
                    ...
                    try {
                        const response = await apiDeleteEducationExperience(
                            rid
                        );
                        if (response.data.success) {
                            ...
                            currentData.value.educationExperiences.splice(
                                index,
                                1
                            );
                        } else {
...
const addWorkExperience = () => {
    ...
    let hasMaxLimit =
        CONFIG.profile.dataConstraints.workExperiences.hasMaxLimit;
...
const removeWorkExperience = async (index, obj) => {
    let hasMinLimit =
        CONFIG.profile.dataConstraints.workExperiences.hasMinLimit;
    ...
    if (hasMinLimit && arrLength <= min) {
        ...
        let rid = obj.rid;
        ElMessageBox.confirm("確定要移除該筆職務經歷嗎?", "警告", {
            confirmButtonText: "確定",
            cancelButtonText: "取消",
            type: "warning",
        })
...
const addeMergencyContacts = () => {
    ...
    let hasMaxLimit =
        CONFIG.profile.dataConstraints.emergencyContacts.hasMaxLimit;
...
const removeeMergencyContacts = (index, obj) => {
    let hasMinLimit =
        CONFIG.profile.dataConstraints.emergencyContacts.hasMinLimit;
    ...
    if (hasMinLimit && arrLength <= min) {
        ...
        let rid = obj.rid;
        ElMessageBox.confirm("確定要移除該筆緊急聯絡人嗎?", "警告", {
            confirmButtonText: "確定",
            cancelButtonText: "取消",
            type: "warning",
        })
                ...
                if (obj.rid) {
                    ...
                    try {
                        ...
                        if (response.data.success) {
                            ...
                            currentData.value.emergencyContacts.splice(
                                index,
                                1
                            );
                        } else {
...
const updateData = () => {
    ...
    let isSelf =
        employeeStore.tmpUserInfo.userName ==
        employeeStore.getUserInfo.userName;
...
const displayUrl=computed(() => {
    return previewimageUrl.value || currentData.value.profileImageUrl || '';
});
// 產生/更新本地預覽（使用 Object URL，比 base64 輕量）
let objectUrl = null;
function setPreview(file) {
    if (objectUrl) {
        URL.revokeObjectURL(objectUrl); // 釋放舊的 URL，避免記憶體外洩
        objectUrl = null;
    }
...
function validateFile(file) {
    ...
    if (!isLt1M) {
        ElMessage.error("上傳的大頭照大小不能超過 1MB!");
        return false;
    }
    return true;
}
// 清除檔案與預覽（對應 <el-upload :on-remove> 或手動呼叫）
function onRemove() {
...
// 更換大頭照
const changeProfileImage = async (uploadFile) => {
    // 設定預覽文件
    ...
    try {
        const res = await apiUploadProfileImage(formData, (progressEvent) => {
        ...
        console.log("res.data.url:",res.data.data.downloadURL);
        // 成功：更新後端回傳的圖片 URL
        if (res.data.data?.downloadURL) {
            onRemove(); // 清除預覽與檔案
            // 這裡也可以順便更新 currentData.profileImageUrl
            console.log("上傳成功，圖片 URL:", res.data.data.downloadURL);
            currentData.value.profileImageUrl = res.data.data.downloadURL;
            console.log("currentData.profileImageUrl:", currentData.value.profileImageUrl);
        }
...
async function doUpload() {
    if (!previewFile.value?.raw) {
        ElMessage.warning("請先選擇要上傳的圖片");
        return;
    }
    const file = previewFile.value.raw;
    if (!validateFile(file)) return;
    ...
    try {
        ...
        const base = import.meta.env.VITE_API_BASE || "/api"; // 建議配合 Vite proxy 或環境變數
        const res = await axios.post(`${base}/upload/profile-image`, formData, {
            ...
            withCredentials: false, // 若走 cookie/session，視需求改為 true
        });

        // 假設後端回傳：{ url: 'https://cdn.example.com/path/to/image.jpg' }
        const uploadedUrl = res.data?.url;
        if (!uploadedUrl) throw new Error("後端未回傳檔案 URL");

        // 用後端回傳的公開網址覆蓋目前頭像
        currentData.value.profileImageUrl = uploadedUrl;
        ...
        console.error(err);
        ElMessage.error(err?.response?.data?.message || "上傳失敗，請稍後再試");
    } finally {
        uploading.value = false;
    }
}
    ...
    if (data.drvingLicense) {
        if (data.drvingLicense.length > 0) {
            ...
            data.drvingLicense.forEach((item) => {
                const findObj = options.value.drvingLicenseList.find(
                    (x) => x.text == item
                );
                if (findObj) {
    ...
    if (data.computerExpertise) {
        if (data.computerExpertise.length > 0) {
            ...
            data.computerExpertise.forEach((item) => {
                const findObj = options.value.expertiseList.find(
                    (x) => x.text == item
                );
                if (findObj) {
                    let obj = { codeNo: findObj.value };
    ...
    if (data.languages) {
        if (data.languages.length > 0) {
            ...
            data.languages.forEach((item) => {
                const findObj = options.value.languageList.find(
                    (x) => x.text == item
                );
                if (findObj) {
                    let obj = { codeNo: findObj.value };
    ...
    if (data.professionalLicense) {
        if (data.professionalLicense.length > 0) {
            ...
            data.professionalLicense.forEach((item) => {
                const findObj = options.value.professionalLicenseList.find(
                    (x) => x.text == item
                );
                if (findObj) {
                    let obj = { codeNo: findObj.value };
    ...
    if (data.specialStatus) {
        if (data.specialStatus.length > 0) {
            ...
            data.specialStatus.forEach((item) => {
                const findObj = options.value.specialStatuList.find(
                    (x) => x.text == item
                );
                if (findObj) {
                    let obj = { codeNo: findObj.value };
