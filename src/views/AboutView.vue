<template>
  <div class="about">
    <el-form :model="curriculumVitae" label-position="top" :size="'large'">
      ...
      <el-row :gutter="10">
            ...
            <el-col :span="24">
                ...
                <el-form-item >
                    <el-row style="width: 100%;" :gutter="10" v-for="(item, index) in curriculumVitae.workExperience"
            ...
            <el-col :span="24">
              ...
              <el-form-item >
                  <el-row style="width: 100%;" :gutter="10" v-for="(item, index) in curriculumVitae.annualPublications"
                      :key="index" class="work-experience-item">
                      <el-col :span="4">
                      ...
                      <el-col :span="4">
                          <el-form-item label="時間">
                              <el-date-picker v-model="item.period" type="month" value-format="YYYY-MM" format="YYYY-MM"
                                  placeholder="時間"  />
                          </el-form-item>
                      </el-col>
                      <el-col :span="13">
          ...
          <el-col :span="24">
            ...
            <el-col :span="24">
              ...
              <el-form-item >
                  <el-row style="width: 100%;" :gutter="10" v-for="(item, index) in curriculumVitae.annualProjects"
                      :key="index" class="work-experience-item">
                      <el-col :span="4">
